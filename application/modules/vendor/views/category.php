    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"> <a class="btn btn-primary" href="<?php echo site_url('vendor/category_list')?>"><i class="fa fa-th-list"><span class="text-align">Category List</span></i></a> </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <form role="form" method="post" action="<?php if(!empty($category[0])){ echo site_url('vendor/category/'.$category[0]->id);}else{echo site_url('vendor/category');} ?>" class="registration_form1" id="category_form" enctype="multipart/form-data" onSubmit="return validate();">
