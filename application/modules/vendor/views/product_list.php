    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"> <a class="btn btn-primary" href="<?php echo site_url('vendor/product')?>"><i class="fa fa-th-list"><span class="text-align">Add Product</span></i></a> </div>
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX" id="tr_<?php echo $count;?>">
                                   ...
                                   <!--  <td>
                                        ...
                                        <img src="<?php echo base_url('asset/uploads/').$value['product_image']; ?>" width="50px" height="50px">
                                        <?php } ?>
                                    </td> -->

                                   
                                    <td class="center">
                                     <a title="Edit" href="<?php echo site_url('vendor/product/').$value['id']; ?>" class="btn btn-success"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
...
function update_status(id,status,tr_id) {
    swal({
        ...
        $.ajax({
            url: "<?php echo site_url('vendor/update_status')?>",
            data: {
                id: id,
                status:status,
                table:'product'
