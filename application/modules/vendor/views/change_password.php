                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <form role="form" method="post" action="<?php echo site_url('vendor/change_password') ?>" class="registration_form1" enctype="multipart/form-data">
