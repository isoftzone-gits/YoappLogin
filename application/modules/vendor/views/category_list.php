    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"> <a class="btn btn-primary" href="#"><i class="fa fa-th-list"><span class="text-align">Add Category</span></i></a> </div>
                        ...
                        <table class="table table-bordered display nowrap" cellspacing="0" width="100%" id="appointment">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX" id="tr_<?php echo $count;?>">
                                   ...
                                   <!--  <td class="center">
                                     <a title="Edit" href="<?php //echo site_url('vendor/category/').$value->id; ?>" class="btn btn-success"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
