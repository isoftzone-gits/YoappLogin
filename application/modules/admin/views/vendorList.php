        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    ...
                    <a class="btn btn-primary" href="<?php echo site_url('admin/vendor_register/')?>"><i class="fa fa-th-list"><span class="text-align">Add Vendor</span></i></a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="tr_<?php echo $i;?>">
                                            ...
                                            <td>
                                                ...
                                                <?php echo ucfirst($users_list->username);?> </td>
                                            ...
                                            <td>
                                                ...
                                                <?php if($users_list->is_active==1){ echo 'Verified';}else{ echo 'Not Verified';}?> </td>

                                           
                                            <td>

                                                 <a href="<?php echo site_url('admin/vendor_register/'.$users_list->id)?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                                 <a href="<?php echo site_url('admin/vendor_permission/'.$users_list->id)?>" class="btn btn-success" ><i class="fa fa-gear"></i></a>
                                                 <a href="javascript:void(0)" onclick="delete_user('<?php echo $users_list->id?>','<?php echo $i;?>')" class="btn btn-danger"><i class="fa fa-trash"></i></a>

                                                 <?php if($users_list->is_active==0){ ?>
