        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a class="btn btn-primary" href="<?php echo site_url('admin/userList')?>"><i class="fa fa-th-list"><span class="text-align">User List</span></i></a>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <form role="form" method="post" action="<?php if(isset($details)){ echo site_url('admin/register/'.$details[0]->id); }else{ echo site_url('admin/register'); }?>" class="registration_form12" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" type="text" placeholder="First Name" name="first_name" id="first_name" autocomplete="off" value="<?php echo !empty($details[0]->first_name)?$details[0]->first_name:'';?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control" type="text" name="last_name" placeholder="Last Name" autocomplete="off" value="<?php echo !empty($details[0]->last_name)?$details[0]->last_name:'';?>">
                                        ...
                                        <div class="formas">
                                            ...
                                            <div class="col-md-9">
                                                <select class="wide form-control" name="user_role">
                                                    <option value="2" <?php if(isset($details) && $details[0]->user_role=='2'){echo 'selected';} ?>>Customer</option>
                                                    <option value="3" <?php if(isset($details) && $details[0]->user_role=='3'){echo 'selected';} ?>>User</option>
