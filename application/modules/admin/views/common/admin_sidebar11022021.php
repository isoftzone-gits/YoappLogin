  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview">
              <a href="#"><i class="fa fa-list-ol"></i> Sub Category
               ...
               <ul class="treeview-menu">
                    <li><a href="<?php echo site_url('admin/sub_category/')?>"><i class="fa fa-plus"></i> Add Sub Category</a></li>
                    <li><a href="<?php echo site_url('admin/sub_cat_list/')?>"><i class="fa fa-eye"></i> View Sub Category</a></li>
               </ul>
            </li>
            ...
            <li class="treeview">
              <a href="#"><i class="fa fa-product-hunt"></i> Products
               ...
               <ul class="treeview-menu">
                    <li><a href="<?php echo site_url('admin/product/')?>"><i class="fa fa-cart-plus"></i> Add Product</a></li>
                    <li><a href="<?php echo site_url('admin/product_list/')?>"><i class="fa fa-list-ul"></i> View Product</a></li>
               </ul>
            </li>

            <li class="treeview">
              <a href="#"><i class="fa fa-user"></i> Users
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
               <ul class="treeview-menu">
                    <li><a href="<?php echo site_url('admin/register/')?>"><i class="fa fa-user-plus"></i> Add User</a></li>
                    <li><a href="<?php echo site_url('admin/userList/')?>"><i class="fa fa-list"></i> View User List</a></li>
               </ul>
            </li>
            ...
            <li class="treeview">
              <a href="#"><i class="fa fa-users"></i> Customers
               ...
               <ul class="treeview-menu">
                    <li><a href="<?php echo site_url('admin/customer_register/')?>"><i class="fa fa-user-plus"></i> Add Customer</a></li>
                    <li><a href="<?php echo site_url('admin/customerList/')?>"><i class="fa fa-list"></i> View Customer List</a></li>
               </ul>
            </li>

            <li class="treeview">
              <a href="#"><i class="fa fa-users"></i> Vendors
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
               <ul class="treeview-menu">
                    <li><a href="<?php echo site_url('admin/vendor_register')?>"><i class="fa fa-user-plus"></i> Add Vendor</a></li>
                    <li><a href="<?php echo site_url('admin/vendorList/')?>"><i class="fa fa-list"></i> View Vendor List</a></li>
               </ul>
            </li>
        ...
        <li><a href="<?php echo site_url('admin/vender_request')?>"><i class="fa fa-bell"></i> <span>Vender Request </span></a></li>
