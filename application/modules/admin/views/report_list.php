    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"> <a class="btn btn-primary" href="javascript:void(0)"><i class="fa fa-th-list"><span class="text-align">Reports</span></i></a> </div>
                <br/><br/>
 <!--               <div class="col-md-12 filter-1">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-bordered display nowrap appointment-1" cellspacing="0" width="100%" id="appointment">
                            <thead>
                                <tr class="bg-primary">
                                    <th>Sr. no</th>
                                    <th>Bill No</th>
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX" id="tr_<?php echo $count;?>">
                                   ...
                                   <!--  <td class="center">
                                     <a title="Edit" href="<?php echo site_url('admin/order_details/').$value->id; ?>" class="btn btn-primary"><i class="fa fa-eye" aria-hidden="true"></i></a>
