    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"> <a class="btn btn-primary" href="<?php echo site_url('admin/discount_coupon')?>"><i class="fa fa-th-list"><span class="text-align">Add Discount Coupon</span></i></a> </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered display nowrap" cellspacing="0" width="100%" id="appointment">
                            ...
                            <tbody>
                                <?php 
                                $count=1;
                                if(isset($discount_coupon_list)){
                                foreach ($discount_coupon_list as  $value) { ?>
                                <tr class="odd gradeX" id="tr_<?php echo $count;?>">
                                    ...
                                    <td class="center">
                                     <a title="Edit" href="<?php echo site_url('admin/discount_coupon/').$value->id; ?>" class="btn btn-success"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                     <?php if($value->status==0){ ?>
