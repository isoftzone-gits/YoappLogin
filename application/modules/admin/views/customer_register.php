        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a class="btn btn-primary" href="<?php echo site_url('admin/customerList')?>"><i class="fa fa-th-list"><span class="text-align">Customer List</span></i></a>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <form role="form" method="post" action="<?php if(isset($details)){ echo site_url('admin/customer_register/'.$details[0]->id); }else{ echo site_url('admin/customer_register'); }?>" class="registration_form12" enctype="multipart/form-data">
