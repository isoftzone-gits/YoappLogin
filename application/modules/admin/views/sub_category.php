    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"> <a class="btn btn-primary" href="<?php echo site_url('admin/sub_cat_list')?>"><i class="fa fa-th-list"><span class="text-align">Sub Category List</span></i></a> </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <form role="form" method="post" action="<?php if(!empty($sub_category[0])){ echo site_url('admin/sub_category/'.$sub_category[0]->id);}else{echo site_url('admin/sub_category');} ?>" class="registration_form1" enctype="multipart/form-data" onSubmit="return validate();">
