        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    ...
                    <a class="btn btn-primary" href="<?php echo site_url('admin/deliverboys_register/')?>"><i class="fa fa-th-list"><span class="text-align">Add DeliveryBoys</span></i></a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="tr_<?php echo $i;?>">
                                            ...
                                            <td>
                                                 ...
                                                 <a href="<?php echo site_url('admin/deliverboys_register/'.$users_list->id)?>" class="btn btn-success"><i class="fa fa-edit"></i></a> 
