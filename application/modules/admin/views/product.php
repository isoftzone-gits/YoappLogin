    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"> <a class="btn btn-primary" href="<?php echo site_url('admin/product_list')?>"><i class="fa fa-th-list"><span class="text-align">Product List</span></i></a> </div>
                <div class="panel-body">
                    
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <form role="form" method="post" action="<?php if(!empty($product[0])){ echo site_url('admin/product/'.$product[0]->id);}else{echo site_url('admin/product');} ?>" class="registration_form1" enctype="multipart/form-data" onSubmit="return validate();">
                           <div class="form-row">
                               <!-- <div class="col-md-6"> -->
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-md-2">Minimum Sale Qty  </label>
                                    <div class="col-md-6">
                                        <input type="text" name="minimum_qty" id="minimum_qty" class="form-control" value="<?php if(!empty($product[0]->product_name)){echo $product[0]->min_qty;}else{ echo set_value('min_qty');}?>" maxlength="30">
                                        <span class="red" id="product_name_error"><?php echo form_error('product_name'); ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-md-2">Incease By</label>
                                    <div class="col-md-6">
                                        <input type="text" name="increase_qty" id="increase_qty" class="form-control" value="<?php if(!empty($product[0]->increase_qty)){echo $product[0]->increase_qty;}else{ echo set_value('increase_qty');}?>" maxlength="30">
                                        <span class="red" id="product_name_error"><?php echo form_error('product_name'); ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-body">
                                ...
                                <?php if(isset($slab)){ 
                                    ...
                                    <?php }?>>
                                     ...
                                     <?php if($i>1){ ?>
                                        ...
                                        <input type="text" id="from" name="from[]" value="<?php echo $slab[$key]->qty_from; ?>" class="form-control " autocomplete="off" placeholder="quantity" >
                                        </div>
                                        <div class="col-md-2" style="margin-bottom: 5px;">
                                          <input type="number" id="to" name="to[]" class="form-control" value="<?php echo $slab[$key]->qty_to; ?>" autocomplete="off"  placeholder="quantity" ></div>

                                        <div class="col-md-1">
                                       <input type="number" id="rate" name="rate[]" class="form-control" value="<?php echo $slab[$key]->rate; ?>" autocomplete="off"  placeholder="rate" ></div>

                                            <div class="col-md-2" >
                                          
                                            <select class="niceSelect wide" id="size" name="size">
                                            <option >select size</option>
                                              <?php foreach($size as $val){ ?>
                                            <option <?php if( $val->name==$slab[$key]->size) { echo 'selected';} ?>><?php echo $val->name; ?></option>
                                           <?php } ?>
                                            </select>
                                            </div>
                                            <div class="col-md-2" >
                                          
                                            <select class="niceSelect wide" id="color" name="color">
                                            <option >select color</option>
                                              <?php foreach($color as $val){ ?>
                                            <option <?php if( $val->name==$slab[$key]->color) { echo 'selected';} ?>><?php echo $val->name; ?></option>
                                           <?php } ?>
                                            </select>
                                            </div>
                                            <div class="col-lg-2" style="display:none">
                                          
                                            <select class="niceSelect wide" id="customer_price" name="customer_price">
                                            <option>select customer price</option>
                                              <?php foreach($customer_price as $val){ ?>
                                            <option <?php if( $val->name==$p_attr[$key]->customer_price) { echo 'selected';} ?>><?php echo $val->name; ?></option>
                                           <?php } ?>
                                            </select>
                                            </div>
                                        <?php if($i>1){?>
                                        <i class="fa fa-minus-circle remove" aria-hidden="true" id="removeslab" style="font-size:25px; padding-left: 15px;"></i>
                                        <?php }else{?>
                                        <div class="col-lg-1 mt-5"> <i class="fa fa-plus-circle" aria-hidden="true" id="slabadd" style="font-size: 25px;"></i> </div>
                                        <?php }?>
                                        <?php if($i>1){?>
                                    </div>
                                    <?php } ?>
                                ...
                                <div class="box-body">    
                                        <div id="slab"> 
                                        <label class="col-md-2">Slab Rate setting * </label>
                                            <div class="col-lg-2" style="margin-bottom: 5px;">
                                               <input type="number" id="from" name="from[]" class="form-control" autocomplete="off"  placeholder=" From Quantity" required="required">
                                                <span class="red"><?php echo form_error('from[]'); ?></span>
                                            </div>

                                            <div class="col-lg-2" style="margin-bottom: 5px;">
                                           <input type="number" id="to" name="to[]" class="form-control" autocomplete="off"  placeholder=" To Quantity" required="required">
                                            </div>

                                            <div class="col-lg-1" style="margin-bottom: 5px;">
                                             <input type="number" id="rate" name="rate[]" class="form-control" autocomplete="off"  placeholder="Rate" required="required">
                                            </div>
                                            <div class="col-lg-2" style="margin-bottom: 5px;">
                                            ...
                                            <div class="col-lg-2" style="margin-bottom: 5px;display:none">
                                            
                                            <label>Customer Price</label>
                                            <select class="niceSelect wide" id="customer_price" name="customer_price">
                                               <option value="">select Customer Price</option>
                                               <?php foreach($size as $val){ ?>
                                               <option><?php echo $val->name;?></option>
                                               <?php } ?>
                                              </select>
                                            ...
                                            <div class="col-lg-1" style="margin-bottom: 5px;">
                                            <i class="fa fa-plus-circle"  aria-hidden="true" id="slabadd" style="font-size: 25px;margin-top:7px;"></i>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
...
<script type="text/javascript">
    ...
    $('#category_id').on('change',function(){
        var id =$(this).val();
        $.ajax({
                url: "<?php echo site_url('admin/get_sequence')?>",
                data: {
                    id: id,
                    column:'category_id',
                    table:'product'
    ...
    $('#sub_cat_id').on('change',function(){
        ...
        $.ajax({
                url: "<?php echo site_url('admin/get_sequence_by_subCategory')?>",
                data: {
                    id: id,
    ...
    $("#add").click(function() {
        ...
        $("#slabadd").click(function() {
            var counter = 2;
            $("#slab").append('<div class="clearfix"></div><div class="form-group" id="box' + counter + '"><label class="col-md-2"></label><div class="col-lg-2" style="margin-bottom: 5px;"><input type="text" id="from" name="from[]" class="form-control " autocomplete="off" placeholder="From Qty" required="required"></div><div class="col-lg-2" style="margin-bottom: 5px;"><input type="number" id="to" name="to[]" class="form-control" autocomplete="off"  placeholder="To Qty" required="required"></div><div class="col-lg-1"><input type="number" id="rate" name="rate[]" class="form-control" autocomplete="off"  placeholder="Rate" required="required"></div><div class="col-lg-2" style="margin-bottom: 5px;"><select class="niceSelect wide form-control" name="size" > <option value="">select size</option><?php foreach($size as $val){ ?><option><?php  echo $val->name;?></option><?php } ?></select> </div>  <div class="col-lg-2" style="margin-bottom: 5px;"> <select class="niceSelect wide form-control" name="color"><option value="">select color</option><?php foreach($color as $val){ ?><option><?php  echo $val->name;?></option><?php } ?></select></div><div class="col-lg-2" style="margin-bottom: 5px;display:none"> <select class="niceSelect wide form-control" name="customer_price"><option value="">select Customer Price</option><option ></option> </select></div><i class="fa fa-minus-circle remove" aria-hidden="true" id="removeslab" style="font-size:25px;margin-left: 15px;"></i></div>');
    ...
    function get_sub_menu(str) {
        $.ajax({
            type: "GET",
            url: "<?php echo site_url('admin/get_record')?>",
            data: {
                id: str,
                table: 'sub_category',
                field: 'category_id',
    ...
    function delete_product_image(image_name,product_id){
        ...
        confirmButtonColor: "#ec6c62"
            ...
            $.ajax({
                url: "<?php echo site_url('admin/delete_product_image')?>",
                data: {
                    id: product_id,
