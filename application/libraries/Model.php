...
class Model
{
    ...
    public function GetJoinRecord1($table, $field_first, $tablejointo, $field_second, $field_val=null, $where=null, $group_by = null, $order_by = null, $order = null)
    {
        if (!empty($field_val)) {
            $this->CI->db->select("$field_val");
        } else {
    ...
    public function sendPushNotification($data, $reg_id) 
    {

        $ci =& get_instance();
         
        $where  = array('name'=>'firebase_key');
        $firebase_key = $this->getAllwhere('settings_masters',$where);

        $apiKey  = !empty($firebase_key) ? $firebase_key[0]->value :"AAAAy2IZZwE:APA91bEaUlJu-uKvJMKmAbjG8xTjsDPrbFWblCanzDE3Bz4k589wHIjvPkhi-p5Wm2S73NOUXlqjlCR3Oul6GJRV0eXgBl5QmB2ZexfeXlhxN9yqh8AN6jQycODGiGLHjiAR9LHR4EGM";
         // $apiKey ="AAAAy2IZZwE:APA91bEaUlJu-uKvJMKmAbjG8xTjsDPrbFWblCanzDE3Bz4k589wHIjvPkhi-p5Wm2S73NOUXlqjlCR3Oul6GJRV0eXgBl5QmB2ZexfeXlhxN9yqh8AN6jQycODGiGLHjiAR9LHR4EGM";
